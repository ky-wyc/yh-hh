...
class KnowledgeDocument(Base):
    ...
    source_file_path: Mapped[str] = mapped_column(String(500), default="")
    source_locator: Mapped[str] = mapped_column(String(255), default="")
    ai_summary: Mapped[str] = mapped_column(Text, default="")
    ai_keywords_json: Mapped[str] = mapped_column(Text, default="[]")
    ai_questions_json: Mapped[str] = mapped_column(Text, default="[]")
    ai_index_status: Mapped[str] = mapped_column(String(32), default="pending")
    enabled: Mapped[bool] = mapped_column(Boolean, default=True)
